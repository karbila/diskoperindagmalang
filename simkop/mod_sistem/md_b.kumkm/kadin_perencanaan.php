  ...
  <div class="span12" id='tbl_rencana' style='margin-left:0px'>
      <div class='page-header'>
          <?php 
            ...
            echo "<h3>Tabel $t[nama_modul]</h3><p>Ada <span class='badge badge-warning'><a href='?md=perennotin' target='_blank'>$jumrow</a></span> Perencanaan yang sudah dilakukan Persiapan</p>";
           ?>
        </div>
