...
<div class="row-fluid">
  ...
  <div class="span12" id='tbl_pelak' style='margin-left: 0px;margin-bottom:20px;'>
                    <div class='page-header'>
                        <h3>Data Kegiatan Pelaksanaan (Assigment) - <?php echo "<span class='badge badge-info'>$jum_pelaks</span>"; ?> Data yang masih dalam tahap Pengawasan sampai Bulan <?php echo "$b"; ?></h3>
                        </div>                        
                        ...
                        <tbody>
                          <?php
                            ...
                            while ($dt = mysql_fetch_array($j)) {
                              ...
                              $h = mysql_query("SELECT pgg.nama_penga, pgg.tgl_awal_penga FROM tbl_pengawasan pgg JOIN tbl_sub_pelaksanaan spl ON spl.id_sub_pelak = pgg.id_sub_pelak JOIN tbl_pelaksanaan pl ON spl.id_pelaksanaan = pl.id_pelaksanaan WHERE pl.id_pelaksanaan = '$dt[id_pelaksanaan]'");
                              echo "<td>";
                              while ($data = mysql_fetch_array($h)) {
                                $tt = dbtoindo($data['tgl_awal_penga']); 
                                echo "<ul>
                                  <li>$data[nama_penga] - <strong>$tt</strong></li>
                                </ul>";
                              }
                              echo "</td>";
                              echo "<td>$awal1</td>
