 ...
 */
define ('PDF_HEADER_LOGO', '_share.png');
...
define ('PDF_HEADER_TITLE', 'DINAS KOPERASI, PERINDUSTRIAN DAN PERDAGANGAN KOTA PASURUAN');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', 'Jalan Pahlawan No. 28 Pasuruan');
// define ('PDF_HEADER_STRING2', 'Telfon');
