  ...
  <div class="span12" id='tbl_pelak' style='margin-left: 0px;margin-bottom:20px;'>
                    <div class='page-header'>
                        <?php 
                          ...
                          echo "<h3>Tabel $t[nama_modul]</h3><p>Ada <span class='badge badge-warning'><a href=\"?md=pelaknotin\" target=\"_blank\">$jumrow</a></span> Pelaksanaan yang sudah dilakukan Pengawasan</p>";
                         ?>
                        </div>
